...
if __name__ == '__main__':
    ...
    parser.add_argument('--baseline_model_fp', type=str, required=True, help='model to load')
    ...
    dataset = PreprocessPointpillarsDataset(preprocess_fp=args.preprocess_fp, gridmap_type=res2.expert_dataset.gridmap_type, feature_mean=res2.expert_dataset.feature_mean, feature_std=res2.expert_dataset.feature_std).to(args.device)

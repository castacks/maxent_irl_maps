...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_dir', type=str, required=True, help='dir of experiments')
    parser.add_argument('--n', type=int, required=False, default=5, help='num of each experiment to run')
